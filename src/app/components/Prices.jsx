      ...
      <div className="max-w-7xl mx-auto ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <div 
            ref={addToCardRefs}
            className="bg-white p-8 rounded-2xl shadow-2xl transition-all duration-300 border-2 border-[#000430]/20 flex flex-col h-full transform hover:-translate-y-2 relative group overflow-hidden hover:shadow-[0_15px_40px_-10px_rgba(0,4,48,0.2)] scale-105 -mt-2"
          >
